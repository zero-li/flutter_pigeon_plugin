...
+ (nullable FLTSearchRequest *)nullableFromList:(NSArray *)list { return (list) ? [FLTSearchRequest fromList:list] : nil; }
- (NSArray *)toList {
  return @[
...
+ (nullable FLTSearchReply *)nullableFromList:(NSArray *)list { return (list) ? [FLTSearchReply fromList:list] : nil; }
- (NSArray *)toList {
  return @[
