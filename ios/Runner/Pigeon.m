...
+ (nullable FLTSearchRequest *)nullableFromMap:(NSDictionary *)dict;
- (NSDictionary *)toMap;
@end
@interface FLTSearchReply ()
+ (FLTSearchReply *)fromMap:(NSDictionary *)dict;
+ (nullable FLTSearchReply *)nullableFromMap:(NSDictionary *)dict;
- (NSDictionary *)toMap;
@end
...
+ (nullable FLTSearchRequest *)nullableFromMap:(NSDictionary *)dict { return (dict) ? [FLTSearchRequest fromMap:dict] : nil; }
- (NSDictionary *)toMap {
  return @{
...
+ (nullable FLTSearchReply *)nullableFromMap:(NSDictionary *)dict { return (dict) ? [FLTSearchReply fromMap:dict] : nil; }
- (NSDictionary *)toMap {
  return @{
